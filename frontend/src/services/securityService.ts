/**
 * Security Service — Agentic-Bug-Hunter DevSecOps integration API client.
 * Connects to /api/v1/security/ endpoints for targets, scans, findings, reports, and tools.
 */
...
export interface SecurityScan {
  ...
  scan_type: string;
  status: "CREATED" | "APPROVAL_PENDING" | "APPROVED" | "QUEUED" | "RUNNING" | "PAUSED" | "COMPLETED" | "FAILED" | "CANCELLED" | "TIMED_OUT" | "BLOCKED";
  initiated_by?: string;
...
export interface SecurityFinding {
  ...
  state: "DISCOVERED" | "TRIAGED" | "VALIDATION_REQUIRED" | "VALIDATED" | "FALSE_POSITIVE" | "DUPLICATE" | "REMEDIATION_REQUIRED" | "IN_PROGRESS" | "FIXED" | "RETEST_REQUIRED" | "RESOLVED" | "ACCEPTED_RISK" | "REJECTED";
  confidence: number;
