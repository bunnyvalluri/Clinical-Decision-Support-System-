...
export function SolutionsRealResults() {
  return (
    <section id="results" className="py-16 sm:py-20 bg-white border-b border-slate-100">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          {/* Left Column: Heading & CTA */}
          <div className="lg:col-span-4 space-y-4 text-left">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-teal-50 border border-teal-200 text-teal-800 text-xs font-mono font-semibold tracking-wide uppercase">
          ...
          <div className="lg:col-span-5">
            <div className="rounded-3xl bg-slate-50/80 border border-slate-200 p-6 sm:p-7 shadow-xs relative">
              <Quote className="h-8 w-8 text-teal-300 absolute top-5 right-5 pointer-events-none" />

              <p className="text-sm sm:text-base text-slate-700 italic leading-relaxed mb-6 relative z-10">
              ...
              <div className="flex items-center gap-3 pt-2 border-t border-slate-200/70">
