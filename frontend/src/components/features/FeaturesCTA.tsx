...
import { ArrowRight, Layers, ShieldCheck, Sparkles, Lock, Activity, CheckCircle2, HeartPulse } from "lucide-react";
        ...
        <div className="rounded-2xl sm:rounded-3xl bg-white border border-slate-300 p-5 sm:p-10 lg:p-14 text-center shadow-xl relative overflow-hidden space-y-6">
          ...
          <div className="max-w-3xl mx-auto space-y-5 relative z-10">
            ...
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto font-normal">
              ...
              machine learning support better-informed clinical workflows without alarm fatigue.
            </p>
