...
const INITIAL_NOTIFICATIONS: ClinicalNotification[] = [
  ...
  },
  {
    ...
    body: "The CDSS knowledge base has been updated with ESC Heart Failure Guidelines 2026. AI Assistant responses now include updated HFrEF treatment pathways.",
    time: "Yesterday",
  ...
  },
  {
    ...
    body: "System maintenance: Sunday 02:00–04:00 UTC. CDSS predictions will be temporarily unavailable. Ensure active cases are reviewed prior.",
    time: "Yesterday",
